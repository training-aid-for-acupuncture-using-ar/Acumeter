 ...
 */
		...
		// C++: void Mat::locateROI(Size wholeSize, Point ofs)
		[DllImport("__Internal")]
		private static extern void core_Mat_locateROI_10 (IntPtr nativeObj, double[] wholeSize_out, double[] ofs_out);
		...
		// C++: Size Mat::size()
		[DllImport("__Internal")]
		private static extern void core_Mat_n_1size (IntPtr nativeObj, double[] vals);
		...
		[DllImport("__Internal")]
		private static extern int core_Mat_nPutD (IntPtr self, int row, int col, int count, double[] data);
		
		[DllImport("__Internal")]
		private static extern int core_Mat_nPutF (IntPtr self, int row, int col, int count, float[] data);
		
		[DllImport("__Internal")]
		private static extern int core_Mat_nPutI (IntPtr self, int row, int col, int count, int[] data);
		
		[DllImport("__Internal")]
		private static extern int core_Mat_nPutS (IntPtr self, int row, int col, int count, short[] data);
		
		[DllImport("__Internal")]
		private static extern int core_Mat_nPutB (IntPtr self, int row, int col, int count, byte[] data);
		
		[DllImport("__Internal")]
		private static extern int core_Mat_nGetB (IntPtr self, int row, int col, int count, byte[] vals);
		
		[DllImport("__Internal")]
		private static extern int core_Mat_nGetS (IntPtr self, int row, int col, int count, short[] vals);
		
		[DllImport("__Internal")]
		private static extern int core_Mat_nGetI (IntPtr self, int row, int col, int count, int[] vals);
		
		[DllImport("__Internal")]
		private static extern int core_Mat_nGetF (IntPtr self, int row, int col, int count, float[] vals);
		
		[DllImport("__Internal")]
		private static extern int core_Mat_nGetD (IntPtr self, int row, int col, int count, double[] vals);
		
		[DllImport("__Internal")]
		private static extern int core_Mat_nGet (IntPtr self, int row, int col, int count, double[] vals);
