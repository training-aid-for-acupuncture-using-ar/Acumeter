 ...
 */
		...
		public static LBPHFaceRecognizer createLBPHFaceRecognizer (int radius, int neighbors, int grid_x, int grid_y, double threshold)
		{
			...
			LBPHFaceRecognizer retVal = new LBPHFaceRecognizer (contrib_FaceRecognizer_createLBPHFaceRecognizer_10 (radius, neighbors, grid_x, grid_y, threshold));
		...
		public static LBPHFaceRecognizer createLBPHFaceRecognizer ()
		{
			...
			LBPHFaceRecognizer retVal = new LBPHFaceRecognizer (contrib_FaceRecognizer_createLBPHFaceRecognizer_11 ());
		...
		public static EigenFaceRecognizer createEigenFaceRecognizer (int num_components, double threshold)
		{
			#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IOS) && !UNITY_EDITOR) || UNITY_5
			
			EigenFaceRecognizer retVal = new EigenFaceRecognizer (contrib_FaceRecognizer_createEigenFaceRecognizer_10 (num_components, threshold));
		...
		public static EigenFaceRecognizer createEigenFaceRecognizer ()
		{
			#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IOS) && !UNITY_EDITOR) || UNITY_5
			
			EigenFaceRecognizer retVal = new EigenFaceRecognizer (contrib_FaceRecognizer_createEigenFaceRecognizer_11 ());
		...
		public static FisherFaceRecognizer createFisherFaceRecognizer (int num_components, double threshold)
		{
			#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IOS) && !UNITY_EDITOR) || UNITY_5
			
			FisherFaceRecognizer retVal = new FisherFaceRecognizer (contrib_FaceRecognizer_createFisherFaceRecognizer_10 (num_components, threshold));
		...
		public static FisherFaceRecognizer createFisherFaceRecognizer ()
		{
			#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IOS) && !UNITY_EDITOR) || UNITY_5
			
			FisherFaceRecognizer retVal = new FisherFaceRecognizer (contrib_FaceRecognizer_createFisherFaceRecognizer_11 ());
		...
		// C++:  void FaceRecognizer::predict(Mat src, int& label, double& confidence)
		[DllImport("__Internal")]
		private static extern void contrib_FaceRecognizer_predict_10(IntPtr nativeObj, IntPtr src_nativeObj, double[] label_out, double[] confidence_out);
		...
		// C++:  Ptr_LBPHFaceRecognizer createLBPHFaceRecognizer(int radius = 1, int neighbors = 8, int grid_x = 8, int grid_y = 8, double threshold = DBL_MAX)
		[DllImport("__Internal")]
		private static extern IntPtr contrib_FaceRecognizer_createLBPHFaceRecognizer_10 (int radius, int neighbors, int grid_x, int grid_y, double threshold);
		
		[DllImport("__Internal")]
		private static extern IntPtr contrib_FaceRecognizer_createLBPHFaceRecognizer_11 ();
		
		// C++:  Ptr_BasicFaceRecognizer createEigenFaceRecognizer(int num_components = 0, double threshold = DBL_MAX)
		[DllImport("__Internal")]
		private static extern IntPtr contrib_FaceRecognizer_createEigenFaceRecognizer_10 (int num_components, double threshold);
		
		[DllImport("__Internal")]
		private static extern IntPtr contrib_FaceRecognizer_createEigenFaceRecognizer_11 ();
		
		// C++:  Ptr_BasicFaceRecognizer createFisherFaceRecognizer(int num_components = 0, double threshold = DBL_MAX)
		[DllImport("__Internal")]
		private static extern IntPtr contrib_FaceRecognizer_createFisherFaceRecognizer_10 (int num_components, double threshold);
		
		[DllImport("__Internal")]
		private static extern IntPtr contrib_FaceRecognizer_createFisherFaceRecognizer_11 ();
				...
				// C++:  void FaceRecognizer::predict(Mat src, int& label, double& confidence)
				[DllImport("opencvforunity")]
				private static extern void contrib_FaceRecognizer_predict_10 (IntPtr nativeObj, IntPtr src_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 1)] double[] label_out, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 1)] double[] confidence_out);
