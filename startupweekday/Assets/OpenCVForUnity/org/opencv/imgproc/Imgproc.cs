...
namespace OpenCVForUnity
{
		public class Imgproc
		{
				...
				public const int BORDER_REPLICATE = IPL_BORDER_REPLICATE;
				public const int BORDER_CONSTANT = IPL_BORDER_CONSTANT;
				public const int BORDER_REFLECT = IPL_BORDER_REFLECT;
				public const int BORDER_WRAP = IPL_BORDER_WRAP;
				public const int BORDER_REFLECT_101 = IPL_BORDER_REFLECT_101;
				public const int BORDER_REFLECT101 = BORDER_REFLECT_101;
				public const int BORDER_TRANSPARENT = IPL_BORDER_TRANSPARENT;
				public const int BORDER_DEFAULT = BORDER_REFLECT_101;
				public const int BORDER_ISOLATED = 16;
				public const int KERNEL_GENERAL = 0;
				public const int KERNEL_SYMMETRICAL = 1;
				public const int KERNEL_ASYMMETRICAL = 2;
				public const int KERNEL_SMOOTH = 4;
				public const int KERNEL_INTEGER = 8;
				public const int MORPH_ERODE = CV_MOP_ERODE;
				public const int MORPH_DILATE = CV_MOP_DILATE;
				public const int MORPH_OPEN = CV_MOP_OPEN;
				public const int MORPH_CLOSE = CV_MOP_CLOSE;
				public const int MORPH_GRADIENT = CV_MOP_GRADIENT;
				public const int MORPH_TOPHAT = CV_MOP_TOPHAT;
				public const int MORPH_BLACKHAT = CV_MOP_BLACKHAT;
				public const int MORPH_RECT = 0;
				public const int MORPH_CROSS = 1;
				public const int MORPH_ELLIPSE = 2;
				public const int GHT_POSITION = 0;
				public const int GHT_SCALE = 1;
				public const int GHT_ROTATION = 2;
				public const int INTER_NEAREST = CV_INTER_NN;
				public const int INTER_LINEAR = CV_INTER_LINEAR;
				public const int INTER_CUBIC = CV_INTER_CUBIC;
				public const int INTER_AREA = CV_INTER_AREA;
				public const int INTER_LANCZOS4 = CV_INTER_LANCZOS4;
				public const int INTER_MAX = 7;
				public const int WARP_INVERSE_MAP = CV_WARP_INVERSE_MAP;
				...
				public const int THRESH_BINARY = CV_THRESH_BINARY;
				public const int THRESH_BINARY_INV = CV_THRESH_BINARY_INV;
				public const int THRESH_TRUNC = CV_THRESH_TRUNC;
				public const int THRESH_TOZERO = CV_THRESH_TOZERO;
				public const int THRESH_TOZERO_INV = CV_THRESH_TOZERO_INV;
				public const int THRESH_MASK = CV_THRESH_MASK;
				public const int THRESH_OTSU = CV_THRESH_OTSU;
				...
				public const int COLOR_COLORCVT_MAX = 135;
				...
				public const int RETR_EXTERNAL = CV_RETR_EXTERNAL;
				public const int RETR_LIST = CV_RETR_LIST;
				public const int RETR_CCOMP = CV_RETR_CCOMP;
				public const int RETR_TREE = CV_RETR_TREE;
				public const int RETR_FLOODFILL = CV_RETR_FLOODFILL;
				public const int CHAIN_APPROX_NONE = CV_CHAIN_APPROX_NONE;
				public const int CHAIN_APPROX_SIMPLE = CV_CHAIN_APPROX_SIMPLE;
				public const int CHAIN_APPROX_TC89_L1 = CV_CHAIN_APPROX_TC89_L1;
				public const int CHAIN_APPROX_TC89_KCOS = CV_CHAIN_APPROX_TC89_KCOS;
 ...
 */
		...
		// C++:  Point2d phaseCorrelate(Mat src1, Mat src2, Mat window = Mat())
		[DllImport("__Internal")]
		private static extern void imgproc_Imgproc_phaseCorrelate_10(IntPtr src1_nativeObj, IntPtr src2_nativeObj, IntPtr window_nativeObj, double[] vals);
		[DllImport("__Internal")]
		private static extern void imgproc_Imgproc_phaseCorrelate_11(IntPtr src1_nativeObj, IntPtr src2_nativeObj, double[] vals);
		
		// C++:  Point2d phaseCorrelateRes(Mat src1, Mat src2, Mat window, double* response = 0)
		[DllImport("__Internal")]
		private static extern void imgproc_Imgproc_phaseCorrelateRes_10(IntPtr src1_nativeObj, IntPtr src2_nativeObj, IntPtr window_nativeObj, double[] response_out, double[] vals);
		[DllImport("__Internal")]
		private static extern void imgproc_Imgproc_phaseCorrelateRes_11(IntPtr src1_nativeObj, IntPtr src2_nativeObj, IntPtr window_nativeObj, double[] vals);
		...
		private static extern void imgproc_Imgproc_watershed_10(IntPtr image_nativeObj, IntPtr markers_nativeObj);
				...
				// C++:  Point2d phaseCorrelate(Mat src1, Mat src2, Mat window = Mat())
				[DllImport("opencvforunity")]
				private static extern void imgproc_Imgproc_phaseCorrelate_10 (IntPtr src1_nativeObj, IntPtr src2_nativeObj, IntPtr window_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] vals);
				...
				// C++:  Point2d phaseCorrelateRes(Mat src1, Mat src2, Mat window, double* response = 0)
				[DllImport("opencvforunity")]
				private static extern void imgproc_Imgproc_phaseCorrelateRes_10 (IntPtr src1_nativeObj, IntPtr src2_nativeObj, IntPtr window_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 1)] double[] response_out, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] vals);

				[DllImport("opencvforunity")]
				private static extern void imgproc_Imgproc_phaseCorrelateRes_11 (IntPtr src1_nativeObj, IntPtr src2_nativeObj, IntPtr window_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] vals);
