 ...
 */
		...
		// C++:  Vec2d EM::predict(Mat sample, Mat& probs = Mat())
		[DllImport("__Internal")]
		private static extern void ml_EM_predict_10(IntPtr nativeObj, IntPtr sample_nativeObj, IntPtr probs_nativeObj, double[] vals);
		[DllImport("__Internal")]
		private static extern void ml_EM_predict_11(IntPtr nativeObj, IntPtr sample_nativeObj, double[] vals);
