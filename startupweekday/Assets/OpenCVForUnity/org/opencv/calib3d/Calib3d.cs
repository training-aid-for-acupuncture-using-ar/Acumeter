...
namespace OpenCVForUnity
{
		public class Calib3d
		{
				...
				private const int CV_LMEDS = 4;
				private const int				CV_RANSAC = 8;
				private const int				CV_FM_LMEDS = CV_LMEDS;
				private const int				CV_FM_RANSAC = CV_RANSAC;
				private const int				CV_FM_7POINT = 1;
				private const int				CV_FM_8POINT = 2;
				private const int				CV_CALIB_USE_INTRINSIC_GUESS = 1;
				private const int				CV_CALIB_FIX_ASPECT_RATIO = 2;
				private const int				CV_CALIB_FIX_PRINCIPAL_POINT = 4;
				private const int				CV_CALIB_ZERO_TANGENT_DIST = 8;
				private const int				CV_CALIB_FIX_FOCAL_LENGTH = 16;
				private const int				CV_CALIB_FIX_K1 = 32;
				private const int				CV_CALIB_FIX_K2 = 64;
				private const int				CV_CALIB_FIX_K3 = 128;
				private const int				CV_CALIB_FIX_K4 = 2048;
				private const int				CV_CALIB_FIX_K5 = 4096;
				private const int				CV_CALIB_FIX_K6 = 8192;
				private const int				CV_CALIB_RATIONAL_MODEL = 16384;
				private const int				CV_CALIB_FIX_INTRINSIC = 256;
				private const int				CV_CALIB_SAME_FOCAL_LENGTH = 512;
				private const int				CV_CALIB_ZERO_DISPARITY = 1024;
				public const int CV_ITERATIVE = 0;
				public const int		CV_EPNP = 1;
				public const int				CV_P3P = 2;
				public const int				LMEDS = CV_LMEDS;
				public const int				RANSAC = CV_RANSAC;
				public const int				ITERATIVE = CV_ITERATIVE;
				public const int				EPNP = CV_EPNP;
				public const int				P3P = CV_P3P;
				...
				public const int				CALIB_USE_INTRINSIC_GUESS = CV_CALIB_USE_INTRINSIC_GUESS;
				public const int				CALIB_FIX_ASPECT_RATIO = CV_CALIB_FIX_ASPECT_RATIO;
				public const int				CALIB_FIX_PRINCIPAL_POINT = CV_CALIB_FIX_PRINCIPAL_POINT;
				public const int				CALIB_ZERO_TANGENT_DIST = CV_CALIB_ZERO_TANGENT_DIST;
				public const int				CALIB_FIX_FOCAL_LENGTH = CV_CALIB_FIX_FOCAL_LENGTH;
				public const int				CALIB_FIX_K1 = CV_CALIB_FIX_K1;
				public const int				CALIB_FIX_K2 = CV_CALIB_FIX_K2;
				public const int				CALIB_FIX_K3 = CV_CALIB_FIX_K3;
				public const int				CALIB_FIX_K4 = CV_CALIB_FIX_K4;
				public const int				CALIB_FIX_K5 = CV_CALIB_FIX_K5;
				public const int				CALIB_FIX_K6 = CV_CALIB_FIX_K6;
				public const int				CALIB_RATIONAL_MODEL = CV_CALIB_RATIONAL_MODEL;
				public const int				CALIB_FIX_INTRINSIC = CV_CALIB_FIX_INTRINSIC;
				public const int				CALIB_SAME_FOCAL_LENGTH = CV_CALIB_SAME_FOCAL_LENGTH;
				public const int				CALIB_ZERO_DISPARITY = CV_CALIB_ZERO_DISPARITY;
				public const int				FM_7POINT = CV_FM_7POINT;
				public const int				FM_8POINT = CV_FM_8POINT;
				public const int				FM_LMEDS = CV_FM_LMEDS;
				public const int				FM_RANSAC = CV_FM_RANSAC;
 ...
 */
		...
		private static extern void calib3d_Calib3d_validateDisparity_11(IntPtr disparity_nativeObj, IntPtr cost_nativeObj, int minDisparity, int numberOfDisparities);
				...
				private static extern void calib3d_Calib3d_RQDecomp3x3_10 (IntPtr src_nativeObj, IntPtr mtxR_nativeObj, IntPtr mtxQ_nativeObj, IntPtr Qx_nativeObj, IntPtr Qy_nativeObj, IntPtr Qz_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 3)] double[] vals);

				[DllImport("opencvforunity")]
				private static extern void calib3d_Calib3d_RQDecomp3x3_11 (IntPtr src_nativeObj, IntPtr mtxR_nativeObj, IntPtr mtxQ_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 3)] double[] vals);
				...
				// C++:  void calibrationMatrixValues(Mat cameraMatrix, Size imageSize, double apertureWidth, double apertureHeight, double& fovx, double& fovy, double& focalLength, Point2d& principalPoint, double& aspectRatio)
				[DllImport("opencvforunity")]
				private static extern void calib3d_Calib3d_calibrationMatrixValues_10 (IntPtr cameraMatrix_nativeObj, double imageSize_width, double imageSize_height, double apertureWidth, double apertureHeight, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 1)] double[] fovx_out, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 1)] double[] fovy_out, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 1)] double[] focalLength_out, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 2)] double[] principalPoint_out, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 1)] double[] aspectRatio_out);
				...
				// C++:  Rect getValidDisparityROI(Rect roi1, Rect roi2, int minDisparity, int numberOfDisparities, int SADWindowSize)
				[DllImport("opencvforunity")]
				private static extern void calib3d_Calib3d_getValidDisparityROI_10 (int roi1_x, int roi1_y, int roi1_width, int roi1_height, int roi2_x, int roi2_y, int roi2_width, int roi2_height, int minDisparity, int numberOfDisparities, int SADWindowSize, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] double[] vals);
				...
				// C++:  float rectify3Collinear(Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2, Mat cameraMatrix3, Mat distCoeffs3, vector_Mat imgpt1, vector_Mat imgpt3, Size imageSize, Mat R12, Mat T12, Mat R13, Mat T13, Mat& R1, Mat& R2, Mat& R3, Mat& P1, Mat& P2, Mat& P3, Mat& Q, double alpha, Size newImgSize, Rect* roi1, Rect* roi2, int flags)
				[DllImport("opencvforunity")]
				private static extern float calib3d_Calib3d_rectify3Collinear_10 (IntPtr cameraMatrix1_nativeObj, IntPtr distCoeffs1_nativeObj, IntPtr cameraMatrix2_nativeObj, IntPtr distCoeffs2_nativeObj, IntPtr cameraMatrix3_nativeObj, IntPtr distCoeffs3_nativeObj, IntPtr imgpt1_mat_nativeObj, IntPtr imgpt3_mat_nativeObj, double imageSize_width, double imageSize_height, IntPtr R12_nativeObj, IntPtr T12_nativeObj, IntPtr R13_nativeObj, IntPtr T13_nativeObj, IntPtr R1_nativeObj, IntPtr R2_nativeObj, IntPtr R3_nativeObj, IntPtr P1_nativeObj, IntPtr P2_nativeObj, IntPtr P3_nativeObj, IntPtr Q_nativeObj, double alpha, double newImgSize_width, double newImgSize_height, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] double[] roi1_out, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] double[] roi2_out, int flags);
				...
				// C++:  void stereoRectify(Mat cameraMatrix1, Mat distCoeffs1, Mat cameraMatrix2, Mat distCoeffs2, Size imageSize, Mat R, Mat T, Mat& R1, Mat& R2, Mat& P1, Mat& P2, Mat& Q, int flags = CALIB_ZERO_DISPARITY, double alpha = -1, Size newImageSize = Size(), Rect* validPixROI1 = 0, Rect* validPixROI2 = 0)
				[DllImport("opencvforunity")]
				private static extern void calib3d_Calib3d_stereoRectify_10 (IntPtr cameraMatrix1_nativeObj, IntPtr distCoeffs1_nativeObj, IntPtr cameraMatrix2_nativeObj, IntPtr distCoeffs2_nativeObj, double imageSize_width, double imageSize_height, IntPtr R_nativeObj, IntPtr T_nativeObj, IntPtr R1_nativeObj, IntPtr R2_nativeObj, IntPtr P1_nativeObj, IntPtr P2_nativeObj, IntPtr Q_nativeObj, int flags, double alpha, double newImageSize_width, double newImageSize_height, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] double[] validPixROI1_out, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = 4)] double[] validPixROI2_out);
